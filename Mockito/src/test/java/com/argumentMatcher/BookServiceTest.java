...
import com.argumentmatcher.Book;
import com.argumentmatcher.BookRepository;
import com.argumentmatcher.BookService;
...
public class BookServiceTest {
	...
	public void testInvalidUseOfArgumentMatchers() {
		...
		// we only use with eq on stub mock objects
